...
public class JsonValidator {
  ...
  public static boolean validateJson(URL schemaUrl, String response) 
        throws IOException, ProcessingException {
    return generateReport(schemaUrl, response);
  }

  private static boolean generateReport(URL schemaUrl, String response)
        throws IOException, ProcessingException {
  ...
  private static ProcessingReport isJsonValid(URL schemaUrl, String response)
        throws IOException, ProcessingException {
